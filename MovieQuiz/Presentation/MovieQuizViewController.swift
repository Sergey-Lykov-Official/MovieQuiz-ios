...
final class MovieQuizViewController: UIViewController {
    ...
    // структура вью модели для состояния "Вопрос показан"
    ...
    // cтруктура для состояния "Результат квиза"
    ...
    private func showNextQuestionOrResults() {
        if currentQuestionIndex == questions.count - 1 { // 1
            ...
            let text = "Ваш результат: \(currentAnswers)/10"
    ...
    // CОЗДАНИЕ ВСПЛЫВАЮЩЕГО ОКНА (АЛЕРТ)
